...
mkdir -p ../content/; wget -q -P ../content https://raw.githubusercontent.com/ollama-tlms-golang/02-rag-first-contact/refs/heads/main/content/chronicles-of-aethelgard.md

echo; go run main.go $args; echo
